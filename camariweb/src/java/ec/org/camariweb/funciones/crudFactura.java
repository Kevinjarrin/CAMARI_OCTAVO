...
public class crudFactura {
    ...
    public ArrayList<clsFactura> findbyAll() {
        ...
        String sql = "SELECT id_factura, clienteid, fecha, subtotal, iva, total "
                + "FROM public.factura";
        // Parametros vacios
        ArrayList<Parametro> lstPar = new ArrayList<>();
        try {
            ...
            while (cres.next()) {
                ...
                factura.setCliente(crudCliente.findbyId(cres.getInt("cliente")));
    ...
    public clsFactura findbyId(clsFactura cli) {
        clsFactura factura = null;
